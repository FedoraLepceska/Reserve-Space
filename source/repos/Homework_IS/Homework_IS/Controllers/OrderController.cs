...
namespace Homework_IS.Controllers
{
    public class OrderController : Controller
    {
        ...
        public FileContentResult CreateInvoice(Guid? orderId)
        {
            ...
            double total = 0;
            foreach (var ticketInOrder in data.TicketInOrders)
            {
                total += ticketInOrder.Quantity * ticketInOrder.OrderedTicket.TicketPrice;
                sb.AppendLine(ticketInOrder.OrderedTicket.Movie + " with quantity of: " + ticketInOrder.Quantity + " and price of: " + ticketInOrder.OrderedTicket.TicketPrice + "MKD");
            }
